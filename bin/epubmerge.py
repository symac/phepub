...
def doMerge(outputio,files,authoropts=[],titleopt=None,descopt=None,
    ...
    for navmap in navmaps:
       ...
       ## text: bookname by authorname
        ...
        # newtext = newTag(tocncxdom,"text",text=string.zfill(str(booknum+1), 2) + ". " +  booktitles[booknum])#+" by "+allauthors[booknum][0])
        # SMA UPDATE to remove the number
        newtext = newTag(tocncxdom,"text",text=booktitles[booknum].replace("PH - ", ""))#+" by "+allauthors[booknum][0])
